...
NSString * const OcSurfaceSuccess = [UIColor colorWithRed:0.902f green:0.961f blue:0.933f alpha:1.000f];
NSString * const OcSurfaceError = [UIColor colorWithRed:0.976f green:0.914f blue:0.906f alpha:1.000f];
